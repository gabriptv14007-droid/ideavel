        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if(session()->has('message'))
                <div class="text-center bg-gray-100 rounded-md p-2">
                    <span class="text-green-600 text-xl font-semibold">{{ session('message') }}</span>
                </div>
            @endif
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 flex space-x-2">
                    ...
                    <div class="flex-1 pl-3">
                        <div class="flex justify-between items-center">
                            <div>
                                <span class="text-gray-800 dark:text-gray-100 p-2">{{ $idea->user->name }}</span>
                ...
                @empty
                    <h2 class="text-xl text-white p-4">No existen ideas!!</h2>
                @endforelse
            </div>
        </div>
    </div>
